...
class TestConvexBridgesFix:
    ...
    def test_separated_rectangles_no_diagonal_cuts(self):
        ...
        result = merge_close_polygons(
            [poly1, poly2], margin=5.0, merge_strategy=MergeStrategy.CONVEX_BRIDGES
        )
    ...
    def test_overlapping_polygons(self):
        ...
        result = merge_close_polygons(
            [poly1, poly2], margin=0.0, merge_strategy=MergeStrategy.CONVEX_BRIDGES
        )
    ...
    def test_single_polygon_unchanged(self):
        ...
        result = merge_close_polygons(
            [poly], margin=5.0, merge_strategy=MergeStrategy.CONVEX_BRIDGES
        )
    ...
    def test_empty_list(self):
        ...
        result = merge_close_polygons(
            [], margin=5.0, merge_strategy=MergeStrategy.CONVEX_BRIDGES
        )
        assert result == []
