"""Core overlap resolution primitives shared by pairwise and batch workflows."""
...
def _to_polygon(geometry: BaseGeometry) -> Polygon:
    ...
    if hasattr(geometry, "geoms"):
        ...
        if polygons:
            return to_single_polygon(polygons[0] if len(polygons) == 1 else unary_union(polygons))
    return Polygon()
